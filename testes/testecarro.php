...
/**
 * Função para exibir os textos dos testes
 *
 * @param Carro $carro
 * @param string $numTeste
 * @param boolean $resultadoDoTeste
 * @return void
 */
function validate(Carro $carro, string $numTeste, bool $resultadoDoTeste) {
    $validaçãoTeste = $carro->validate();

    if (!boolval($validaçãoTeste) === $resultadoDoTeste) {
